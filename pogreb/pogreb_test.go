...
import (
	...
	"github.com/philippgille/gokv/pogreb"
...
func createStore(t *testing.T, codec encoding.Codec) (pogreb.Store, string) {
...
func generateRandomTempDbPath(t *testing.T) string {
	path, err := ioutil.TempDir(os.TempDir(), "pogreb")
	if err != nil {
